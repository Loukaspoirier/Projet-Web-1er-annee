...
<head>
    ...
    <style>
        ...
        <?php //Pour rendre la page en noir ou blanc ?>
        .toggle-button {
...
<body>
    ...
    $criticController = new CriticController();

    // Barre de navigation commun à toute les pages
    ?>
    <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top" id="navbar">
        <div class="container-fluid">
            <a class="navbar-brand" href="./index.php"><img src="./Images/LogoDark.png" alt="Logo"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./reviewForm.php">Rédiger une revue</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./xbox.php">Xbox Series X</a>
                    </li>
                    <i class="nav-item">
                    ...
                    <i class="nav-item" id="icon">
                        <button class="toggle-button" onclick="toggleMode()"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-sun" viewBox="0 0 16 16">
